...
class NotebookExperimantalSpec: QuickSpec {
    override func spec() {
        let note = Experimental.Note.Model(uuid: "noteUUID", title: "title", content: "content", tags: [], updatedDate: 0, createdDate: 123)
        ...
        describe("-evaluate:") {
            ...
            context("when receiving removeNote event") {
                ...
                context("when passed note is not exist") {
                    let notAddedNote = Experimental.Note.Model(uuid: "noteAddedNoteUUID", title: "title", content: "content", tags: [], updatedDate: 0, createdDate: 14)
