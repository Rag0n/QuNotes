...
/// \param frame The frame of the text editor.
///
/// \param themeFile The name of the theme file to use.
///
///
/// returns:
/// A new Notepad.
- (nonnull instancetype)initWithFrame:(CGRect)frame themeFile:(NSString * _Nonnull)themeFile;
...
@interface UIColor (SWIFT_EXTENSION(Notepad))
@end
